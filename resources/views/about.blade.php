            ...
            <section id="hero" style="scroll-behavior: smooth" class="mb-10">
                <div  class=" bg-white rounded-3xl mx-12 mt-32 md:h-96 flex flex-col md:flex-row" >
                    ...
                    <div class="w-full xl:w-1/2">
                        ...
                        <p class="text-black px-10 py-2 ">Pengguna dapat melihat akumulasi dari capaian kinerja, realisasi anggaran, dan frekuensi upload file FRA secara lebih ringkas dan interaktif. </p>
                        @if (Route::has('login'))
                @auth
...
<footer class="bg-white rounded-lg   mt-12 mx-5 dark:bg-gray-800">
    <div class="w-full mx-auto max-w-full p-6 flex lg:items-center justify-between">
      <span class="text-xs md:text-sm text-black  dark:text-gray-400">© 2023 <a href="./" class="hover:underline">Badan Pusat Statistik.</a> 
    </span>
