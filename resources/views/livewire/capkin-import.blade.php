<div class="">
    <x-button type="button"
        class="px-5 py-3 text-base font-medium text-center border-2 border-collapse bg-slate-400 text-white hover:bg-transparent hover:text-slate-500 hover:border-slate-500 focus:ring-2 focus:ring-slate-200 focus:bg-transparent focus:text-slate-500 active:bg-transparent"
            ...
            <x-slot name="content">
                <div class="grid grid-flow-row">
                    <div class="grid grid-flow-col grid-cols-3 my-2">
                        ...
                        <x-input id="file" class="border flex items-center col-span-2" type="file"
                            wire:model="file" />
                    </div>
